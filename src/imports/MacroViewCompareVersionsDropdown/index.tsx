import svgPaths from "./svg-10e4vg4qc0";
...
function Progress() {
  return (
    <div className="absolute contents left-[994px] top-[77px]" data-name="progress">
      ...
      <div className="absolute flex h-[6px] items-center justify-center left-[994px] top-[77px] w-[154px]">
        <div className="-scale-y-100 flex-none">
          <div className="bg-[#0d64e0] h-[6px] relative rounded-[2px] w-[154px]" />
        </div>
      </div>
    </div>
  );
...
function Kpi() {
  return (
    <div className="absolute contents left-[963px] top-[70px]" data-name="KPI">
      <Progress />
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Regular',sans-serif] leading-[18px] left-[1179px] not-italic text-[#2d2d2d] text-[12px] top-[70px] whitespace-nowrap">80%</p>
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Regular',sans-serif] leading-[18px] left-[963px] not-italic text-[#2d2d2d] text-[12px] top-[70px] whitespace-nowrap">8/10</p>
    </div>
  );
}
...
function Dividers() {
  return (
    <div className="absolute h-[631.635px] left-[42.88px] top-[262px] w-[1180.765px]" data-name="dividers">
      <div className="absolute inset-[-0.16%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1180.77 632.635">
          <g id="dividers">
            <line id="Line 1" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="63.6635" y2="63.6635" />
            <line id="Line 2" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="126.827" y2="126.827" />
            <line id="Line 10" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="0.5" y2="0.5" />
            <line id="Line 3" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="189.991" y2="189.991" />
            <line id="Line 4" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="253.154" y2="253.154" />
            <line id="Line 5" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="379.481" y2="379.481" />
            <line id="Line 11" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="442.645" y2="442.645" />
            <line id="Line 9" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="505.808" y2="505.808" />
            <line id="Line 12" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="568.972" y2="568.972" />
            <line id="Line 13" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="632.135" y2="632.135" />
            <line id="Line 6" stroke="var(--stroke-0, #ECECEC)" x2="1180.77" y1="316.318" y2="316.318" />
          </g>
        </svg>
      </div>
    </div>
...
function Group1() {
  return (
    <div className="absolute contents left-[952px] top-[344.37px]">
      <div className="absolute bg-[rgba(152,225,132,0.4)] h-[23.76px] left-[952px] rounded-[8px] top-[344.37px] w-[68.658px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[958.97px] not-italic text-[#285f19] text-[12px] top-[346.35px] tracking-[-0.132px] w-[54.727px] whitespace-pre-wrap">
...
function Group9() {
  return (
    <div className="absolute contents left-[952px] top-[280px]">
      <div className="absolute bg-[rgba(152,225,132,0.4)] h-[23.76px] left-[952px] rounded-[8px] top-[280px] w-[68.658px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[958.97px] not-italic text-[#285f19] text-[12px] top-[281.98px] tracking-[-0.132px] w-[54.727px] whitespace-pre-wrap">
        <p className="leading-[1.5] mb-0">Expected</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5]">​</p>
...
function Group2() {
  return (
    <div className="absolute contents left-[952px] top-[469.11px]">
      <div className="absolute bg-[rgba(152,225,132,0.4)] h-[23.76px] left-[952px] rounded-[8px] top-[469.11px] w-[68.658px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[958.97px] not-italic text-[#285f19] text-[12px] top-[471.09px] tracking-[-0.132px] w-[54.727px] whitespace-pre-wrap">
        <p className="leading-[1.5] mb-0">Expected</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5]">​</p>
...
function Group3() {
  return (
    <div className="absolute contents left-[952px] top-[531.48px]">
      <div className="absolute bg-[rgba(152,225,132,0.4)] h-[23.76px] left-[952px] rounded-[8px] top-[531.48px] w-[68.658px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[958.97px] not-italic text-[#285f19] text-[12px] top-[533.46px] tracking-[-0.132px] w-[54.727px] whitespace-pre-wrap">
        <p className="leading-[1.5] mb-0">Expected</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5]">​</p>
...
function Group4() {
  return (
    <div className="absolute contents left-[952px] top-[599.8px]">
      <div className="absolute bg-[rgba(152,225,132,0.4)] h-[23.76px] left-[952px] rounded-[8px] top-[599.8px] w-[68.658px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[958.97px] not-italic text-[#285f19] text-[12px] top-[601.78px] tracking-[-0.132px] w-[54.727px] whitespace-pre-wrap">
        <p className="leading-[1.5] mb-0">Expected</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5]">​</p>
...
function Group5() {
  return (
    <div className="absolute contents left-[952px] top-[668.11px]">
      <div className="absolute bg-[rgba(152,225,132,0.4)] h-[23.76px] left-[952px] rounded-[8px] top-[668.11px] w-[68.658px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[958.97px] not-italic text-[#285f19] text-[12px] top-[670.09px] tracking-[-0.132px] w-[54.727px] whitespace-pre-wrap">
        <p className="leading-[1.5] mb-0">Expected</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5]">​</p>
...
function Group6() {
  return (
    <div className="absolute contents left-[952px] top-[853.24px]">
      <div className="absolute bg-[rgba(152,225,132,0.22)] h-[23.76px] left-[952px] rounded-[8px] top-[853.24px] w-[68.658px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[958.97px] not-italic text-[12px] text-[rgba(40,95,25,0.69)] top-[855.22px] tracking-[-0.132px] w-[54.727px] whitespace-pre-wrap">
        <p className="leading-[1.5] mb-0">Expected</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5]">​</p>
...
function Group7() {
  return (
    <div className="absolute contents left-[952px] top-[791.86px]">
      <div className="absolute bg-[rgba(152,225,132,0.4)] h-[23.76px] left-[952px] rounded-[8px] top-[791.86px] w-[68.658px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[958.97px] not-italic text-[#285f19] text-[12px] top-[793.84px] tracking-[-0.132px] w-[54.727px] whitespace-pre-wrap">
        <p className="leading-[1.5] mb-0">Expected</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5]">​</p>
...
function Group() {
  return (
    <div className="absolute contents left-[956.98px] top-[404.76px]">
      <div className="absolute bg-[rgba(238,176,118,0.48)] h-[23.76px] left-[956.98px] rounded-[8px] top-[404.76px] w-[59.703px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[962.95px] not-italic text-[#925a25] text-[12px] top-[406.74px] tracking-[-0.132px] w-[50.747px] whitespace-pre-wrap">
...
function Group8() {
  return (
    <div className="absolute contents left-[954.99px] top-[727px]">
      <div className="absolute bg-[rgba(238,176,118,0.48)] h-[23.76px] left-[954.99px] rounded-[8px] top-[727px] w-[59.703px]" />
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[18.81px] leading-[0] left-[960.96px] not-italic text-[#925a25] text-[12px] top-[728.98px] tracking-[-0.132px] w-[50.747px] whitespace-pre-wrap">
        <p className="leading-[1.5] mb-0">Flagged</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5]">​</p>
...
function StatusBadges() {
  return (
    <div className="absolute contents left-[952px] top-[280px]" data-name="status badges">
      <Group1 />
      <Group9 />
      <Group2 />
      <Group3 />
...
function Accordion() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[673.18px] w-[22.886px]" data-name="accordion">
...
function Accordion1() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[291px] w-[22.886px]" data-name="accordion">
      <div className="absolute inset-[-6.8%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.886 11.3858">
          <g id="accordion">
            <line id="Line 932" stroke="var(--stroke-0, black)" transform="matrix(0.731663 0.681666 -0.689048 0.724716 3.75579e-05 0.724716)" x2="15.6397" y1="-0.5" y2="-0.5" />
...
function Accordion2() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[353.05px] w-[22.886px]" data-name="accordion">
      <div className="absolute inset-[-6.8%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.886 11.3858">
          <g id="accordion">
            <line id="Line 932" stroke="var(--stroke-0, black)" transform="matrix(0.731663 0.681666 -0.689048 0.724716 3.75579e-05 0.724716)" x2="15.6397" y1="-0.5" y2="-0.5" />
...
function Accordion3() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[415.11px] w-[22.886px]" data-name="accordion">
      <div className="absolute inset-[-6.8%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.886 11.3858">
          <g id="accordion">
            <line id="Line 932" stroke="var(--stroke-0, black)" transform="matrix(0.731663 0.681666 -0.689048 0.724716 3.75579e-05 0.724716)" x2="15.6397" y1="-0.5" y2="-0.5" />
...
function Accordion4() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[477.16px] w-[22.886px]" data-name="accordion">
      <div className="absolute inset-[-6.8%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.886 11.3858">
          <g id="accordion">
            <line id="Line 932" stroke="var(--stroke-0, black)" transform="matrix(0.731663 0.681666 -0.689048 0.724716 3.75579e-05 0.724716)" x2="15.6397" y1="-0.5" y2="-0.5" />
...
function Accordion5() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[539.22px] w-[22.886px]" data-name="accordion">
      <div className="absolute inset-[-6.8%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.886 11.3858">
          <g id="accordion">
            <line id="Line 932" stroke="var(--stroke-0, black)" transform="matrix(0.731663 0.681666 -0.689048 0.724716 3.75579e-05 0.724716)" x2="15.6397" y1="-0.5" y2="-0.5" />
...
function Accordion6() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[610.14px] w-[22.886px]" data-name="accordion">
      <div className="absolute inset-[-6.8%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.886 11.3858">
          <g id="accordion">
            <line id="Line 932" stroke="var(--stroke-0, black)" transform="matrix(0.731663 0.681666 -0.689048 0.724716 3.75579e-05 0.724716)" x2="15.6397" y1="-0.5" y2="-0.5" />
...
function Accordion7() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[735.23px] w-[22.886px]" data-name="accordion">
      <div className="absolute inset-[-6.8%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.886 11.3858">
          <g id="accordion">
            <line id="Line 932" stroke="var(--stroke-0, black)" transform="matrix(0.731663 0.681666 -0.689048 0.724716 3.75579e-05 0.724716)" x2="15.6397" y1="-0.5" y2="-0.5" />
...
function Accordion8() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[797.28px] w-[22.886px]" data-name="accordion">
      <div className="absolute inset-[-6.8%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.886 11.3858">
          <g id="accordion">
            <line id="Line 932" stroke="var(--stroke-0, black)" transform="matrix(0.731663 0.681666 -0.689048 0.724716 3.75579e-05 0.724716)" x2="15.6397" y1="-0.5" y2="-0.5" />
...
function Accordion9() {
  return (
    <div className="absolute h-[10.661px] left-[1168.28px] top-[859.34px] w-[22.886px]" data-name="accordion">
      <div className="absolute inset-[-6.8%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.886 11.3858">
          <g id="accordion">
...
function Accordions() {
  return (
    <div className="absolute contents left-[1168.28px] top-[291px]" data-name="accordions">
      <Accordion />
      <Accordion1 />
      <Accordion2 />
      <Accordion3 />
...
function TextBody() {
  return (
    <div className="absolute contents left-[19px] top-[232px]" data-name="text body">
      <Dividers />
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] leading-[18px] left-[35.07px] not-italic text-[#464646] text-[12px] top-[232px] tracking-[0.24px] w-[87.363px]">QUESTIONS</p>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] leading-[18px] left-[986.33px] not-italic text-[#464646] text-[12px] text-center top-[232px] tracking-[0.24px] w-[48.757px]">STATUS</p>
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Regular',sans-serif] leading-[0] left-[36.91px] not-italic text-[#2d2d2d] text-[14px] top-[280px] tracking-[-0.154px] w-[828.872px] whitespace-pre-wrap">
        ...
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="font-['SF_Pro_Text:Medium',sans-serif] leading-[1.5] mb-0">5. Who are the primary customers that are buying sporting goods?</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        ...
        <p className="leading-[1.5] mb-0">​</p>
        <p className="leading-[1.5] mb-0">​</p>
        <p className="font-['SF_Pro_Text:Medium',sans-serif] leading-[1.5] text-[#7b7b7b]">10. What is the most popular item that is listed under accessories and has been purchased in at least..</p>
      </div>
      <StatusBadges />
      <Accordions />
      <div className="absolute h-[11px] left-[19px] top-[412px] w-[10.945px]">
      ...
      <div className="absolute h-[11px] left-[19px] top-[727px] w-[10.945px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.9455 11">
          <ellipse cx="5.47274" cy="5.5" fill="var(--fill-0, #EEB076)" id="Ellipse 1" rx="5.47274" ry="5.5" />
        </svg>
      </div>
...
function RecommendationCards() {
  return (
    <div className="[word-break:break-word] absolute bg-[#f4f7fa] content-stretch drop-shadow-[0px_1px_1px_rgba(41,49,59,0.1)] flex flex-col gap-[6px] h-[98px] items-start leading-[20px] left-[24px] not-italic pl-[13px] pr-[12px] py-[10px] rounded-[8px] top-[109px] w-[1181px]" data-name="Recommendation Cards">
  ...
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white h-[894px] left-[calc(50%-189px)] overflow-clip rounded-[8px] shadow-[0px_2px_15px_0px_rgba(0,0,0,0.15)] top-[calc(50%+3px)] w-[1251px]" data-name="Question Panel">
      ...
      <div className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] leading-[0] left-[37px] not-italic text-[0px] text-black top-[52px] tracking-[0.24px] whitespace-nowrap">
        ...
        <p className="font-['SF_Pro_Text:Regular',sans-serif] leading-[18px] text-[12px] text-[rgba(45,45,45,0.69)] whitespace-pre">Just now</p>
      </div>
      <Kpi />
...
function Box() {
  return (
    <div className="bg-[#f2f3f5] h-[188px] overflow-clip relative rounded-[4px] shrink-0 w-full" data-name="Box">
      ...
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Regular',sans-serif] leading-[18px] left-[12px] not-italic text-[14px] text-black top-[6px] tracking-[-0.154px] w-[332px]">A sale refers to an individual order which may contain multiple products.</p>
      <div className="absolute bg-[rgba(152,225,132,0.22)] h-[17px] left-[7px] top-[65px] w-[314px]" />
      <div className="absolute bg-[rgba(152,225,132,0.22)] h-[17px] left-[7px] top-[84px] w-[29px]" />
      <div className="absolute bg-[rgba(152,225,132,0.22)] h-[17px] left-[7px] top-[46px] w-[307px]" />
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Regular',sans-serif] leading-[18px] left-[10px] not-italic text-[14px] text-black top-[44px] tracking-[-0.154px] w-[328px]">Revenue is defined as the sum of product prices associated with a specific order including shipping fee.</p>
    </div>
  );
}
...
function ListItems1() {
  return (
    <div className="h-[34px] relative shrink-0 w-[210px]" data-name="List items">
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Regular',sans-serif] leading-[20px] left-[9px] not-italic text-[#181825] text-[14px] top-[calc(50%-9px)] tracking-[0.28px] whitespace-nowrap">Version 2 Agent</p>
    </div>
  );
}
...
function ListItems2() {
  return (
    <div className="h-[34px] relative shrink-0 w-[210px]" data-name="List items">
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Regular',sans-serif] leading-[20px] left-[9px] not-italic text-[#181825] text-[14px] top-[calc(50%-9px)] tracking-[0.28px] whitespace-nowrap">Compare Versions</p>
    </div>
  );
}
...
function AutoModelingMenu() {
  return (
    <div className="absolute bg-white content-stretch drop-shadow-[0px_3px_5px_rgba(24,24,37,0.2)] flex flex-col h-[113px] items-start left-[10.56px] px-[4px] py-[10px] rounded-[8px] top-[43px] w-[155px]" data-name="Auto Modeling Menu">
      <ListItems />
      <ListItems1 />
      <div className="h-0 relative shrink-0 w-[146px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 146 1">
            <line id="Line 931" stroke="var(--stroke-0, #D9D9D9)" x2="146" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <ListItems2 />
...
function RunQueryDropdown() {
  return (
    <div className="absolute contents left-[10.56px] top-[43px]" data-name="run query dropdown">
      <AutoModelingMenu />
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Regular',sans-serif] h-[14.771px] leading-[20px] left-[22.56px] not-italic text-[#181825] text-[14px] top-[calc(50%-455.71px)] w-[146px]">Baseline Agent</p>
    </div>
  );
}

export default function MacroViewCompareVersionsDropdown() {
  return (
    <div className="bg-[#fafafa] relative size-full" data-name="Macro View Compare Versions Dropdown">
      ...
      <QuestionPanel />
      <Button />
      <div className="absolute bg-white border border-[#e7e9eb] border-solid left-[1607px] overflow-clip rounded-[20px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.05)] size-[34px] top-[848px]" data-name="Suggestion">
        <Suggestions />
      </div>
