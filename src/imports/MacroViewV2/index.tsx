import svgPaths from "./svg-11s0w4ry8b";
...
function AiSuggestionsV4Micro() {
  return (
    <div className="absolute bg-white h-[700px] left-[1277px] overflow-clip rounded-[8px] shadow-[-1px_0px_12px_0px_rgba(0,0,0,0.15)] top-[68px] w-[379px]" data-name="AI suggestions V4 - micro">
      <TabBar />
      <CustomInstructions />
      <Lightbulb />
    ...
    <div className="h-[28px] relative shrink-0 w-[324px]" data-name="Query Box Bottom">
      <div className="absolute left-[301px] size-[20px] top-[4px]" data-name="Query Box Icons">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
          <g clipPath="url(#clip0_1_3450)" id="Bulb">
...
function QueryBoxEntry() {
  return (
    <div className="absolute bg-white drop-shadow-[-1px_2px_6px_rgba(0,0,0,0.13)] h-[179px] left-[1276px] rounded-[8px] top-[783px] w-[380px]" data-name="Query Box Entry">
      <QueryBox />
...
export default function MacroViewV() {
  return (
    <div className="bg-[#fafafa] relative size-full" data-name="Macro View V2">
