import svgPaths from "./svg-vo4yq5zuof";
...
export default function DropdownInput() {
  return (
    <div className="bg-[rgba(153,180,208,0.1)] content-stretch flex items-center justify-between overflow-clip px-[10px] py-[11px] relative rounded-[6px] size-full" data-name="Dropdown Input">
      <TextWithCursor />
